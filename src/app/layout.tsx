...
.site-header{position:sticky;top:0;z-index:50;border-bottom:1px solid var(--line);background:rgba(255,255,255,.94)}
...
.menu-toggle{display:inline-flex;height:2.5rem;width:2.5rem;align-items:center;justify-content:center;border:1px solid var(--line);border-radius:.75rem;background:#fff}
.mobile-nav{display:flex;flex-direction:column;gap:.25rem;border-top:1px solid var(--line);padding:1rem 0;background:#fff}
...
@media(min-width:1024px){.hero-grid{grid-template-columns:1.05fr .95fr;padding:6rem 0}.site-footer-grid{grid-template-columns:1.4fr .8fr .8fr .8fr .8fr}}
            `,
          }}
        />
